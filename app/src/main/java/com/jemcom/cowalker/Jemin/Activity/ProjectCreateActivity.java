...
public class ProjectCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn = (Button) findViewById(R.id.create1_next_btn);
        titleEdit = (EditText) findViewById(R.id.create1_title_edit);
        summaryEdit = (EditText) findViewById(R.id.create1_summary_edit);
        ...
        final Spinner purposeSpinner = (Spinner) findViewById(R.id.create1_purpose_spinner);
        final Spinner fieldSpinner = (Spinner) findViewById(R.id.create1_field_spinner);
        final Spinner locationSpinner = (Spinner) findViewById(R.id.create1_location_spinner);
